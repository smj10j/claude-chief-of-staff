...
4. **Run tests** - Run all relevant tests (`node --test data/tests/*.test.js`) and make sure they pass. Fix any failures before proceeding. If you wrote new code, there must be new tests.
