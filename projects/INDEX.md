...
- **Tasks link to projects** via the `project` field in the task database. Value = folder ID above.
- To start a project: create `projects/<id>/` folder, add a row here, add tasks with matching `project` field.
